...
\item How using a (frequent) demo based development improves z (right prioritization of functionality etc.) (See scrum pm)
...
By using a task-management tool we can improve upon the documentability and traceability of our work.
...
By working in scrum, all responsibility, including quality assurance, is spread equally over team members.
